...
public class LobbyJavaFX extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        */
        ...
        joinedPlayers.add(new Player("carlo","red"));
        joinedPlayers.add(new Player("gregorio","blue"));
        joinedPlayers.add(new Player("pippo","green"));
        joinedPlayers.add(new Player("pluto","gray"));
        joinedPlayers.add(new Player("paperino","yellow"));
